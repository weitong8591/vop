...
class _PairDataset(torch.utils.data.Dataset):
    ...
    def getitem(self, idx):
        if self.conf.views == 2:
            ...
            kpj_i, inl0, kpi_i = dense_warp_consistency(
            data["depth0"],
            data["depth1"],
            data["T_0to1"],
            data["camera0"],
            ...
            kpi_j, inl1, kpj_j = dense_warp_consistency(
            data["depth1"],
            data["depth0"],
            data["T_1to0"],
            data["camera1"],
            ...
            if (min(gt_vis_image0.sum(), gt_vis_image1.sum())>0 and overlap>0):
                ...
                for l in data["gt_labels"][0].nonzero():
                    if any(l[0] == coord[0] and l[1] == coord[1] for coord in gt_labels1[0].nonzero()):
                        pass
                    else:
                        data["gt_labels"][0][l[0], l[1]] = 0
